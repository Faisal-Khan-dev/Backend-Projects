...
const Notes = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 p-4 md:p-8 rounded-xl">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
            {notes.map((item, index) => {
              ...
              return (
                ...
                >
                  {/* Action Buttons - One on left and one on right */}
                  ...
                  {/* Note Content - Below the buttons */}
